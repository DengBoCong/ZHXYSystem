            ...
            <div class="span8 main-listing">
                ...
                <article class="format-standard type-post hentry clearfix">
                    ...
                    <header class="clearfix">
                        ...
                        <h3 class="post-title">
                            <a href="<%=basePath%>/jsp/confession/confession_detail.jsp">林沫好帅啊！求联系方式</a>
                        </h3>
                    ...
                    <p>我们中的许多人都在无休止的任务流、浏览器任务、社交媒体、电子邮件、会议中工作，从一件事奔向另一件事，永不停歇，永不停息。&nbsp;那一天就结束了，我们精疲力竭了，我们常常没有什么东西可以炫耀。我们从下一个开始 . . . <a class="readmore-link" href="<%=basePath%>/jsp/confession/confession_detail.jsp">查看更多</a></p>
