                        ...
                        <section class="hbox stretch">
                            <aside class="bg-white">
                                <section class="vbox">
                                    <div class="col-sm-12">
                                        <h4>参赛团队成员</h4>
                                        <a class="btn btn-rounded btn-sm btn-info" style="float: right;">添加团队成员</a>
                                        <h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1、每个参赛团队限5名成员（含队长）</h6>
                                        <h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、以下队员列表顺序即为获奖名单上的排列顺序</h6>
                                        <section class="panel panel-default">
                                            <header class="panel-heading text-center">
                                                <strong>我的团队成员 1</strong></br>
                                            </header>
                                        ...
                                        <section class="panel panel-default">
                                            <header class="panel-heading text-center">
                                                <strong>我的团队成员 2</strong></br>
                                            </header>
                                            <div class="panel-body">
                                                <div class="col-sm-3">
                                                    <img src="<%=basePath%>/img/head.png" style="height: 150px;">
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="col-sm-12" style="margin-top: 10px;">
                                                        <span>姓名:林沫</span>
