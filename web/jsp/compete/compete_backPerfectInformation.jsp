                                        ...
                                        <form class="form-horizontal" data-validate="parsley">
                                            <section class="panel panel-default">
                                                <header class="panel-heading text-center">
                                                    <strong>团队信息</strong></br>
                                                    <span style="color: #3C763D;">报名状态：通过审核！</span>
                                                </header>
                                                <div class="panel-body">
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">团队编号</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="1800254" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">注册账号</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="18870125082" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">队伍名称</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="Amazing" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">报名区域</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="北京市" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">报名高校</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="清华大学" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">高校地址</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="北京市海淀区清华大学" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Email</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="1210212670@qq.com" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">联系人</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="林沫" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="100083" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">参赛承诺书</label>
                                                        <div class="col-sm-9 text-center">
                                                            <a href="#"><span style="color: #4D97C2;">点击查看</span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <footer class="panel-footer text-right bg-light lter">
                                                    <span style="float: left;margin-top: 10px;">组委会会对报名信息进行审核，修改信息需要重新审核</span>
                                                    <button type="submit" class="btn btn-success btn-s-xs">修改报名信息</button>
                                                </footer>
                                            </section>
                                        </form>
                                    </div>
