                        ...
                        <section class="hbox stretch">
                            <aside class="bg-white">
                                <section class="vbox">
                                    <div class="col-sm-12">
                                        <h4>A组赛题答疑</h4>
                                        <a class="btn btn-rounded btn-sm btn-info" style="float: right;">添加新问题</a>
                                        <h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1、团队请根据申请的A组选题提问</h6>
                                        <h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、相关问题汇总由后组委会提交出题方，由出题方统一解答后公布</h6>
                                        <section class="panel panel-default">
                                            <header class="panel-heading text-center">
                                                <strong>赛题名称：【A06】智能网联汽车驾驶健康伙伴系统【东软睿道】</strong></br>
                                            </header>
