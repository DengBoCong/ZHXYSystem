                                                ...
                                                <div class="col-sm-8">
                                                    <section class="panel panel-default">
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">团队审核状态</label>
                                                                <div class="col-sm-9">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" value="2018-12-20 09:08:34" disabled="disabled">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">赛题类型</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" value="A类" disabled="disabled">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">A类赛题</label>
                                                                <div class="col-sm-9">
                                                                    <select data-required="true" class="form-control" disabled="disabled">
                                                                        <option value="" selected="selected">【A06】智能网联汽车驾驶健康伙伴系统【东软睿道】</option>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">赛题描述</label>
                                                                <div class="col-sm-9">
                                                                    <div class="input-group">
                                                                        <span class="input-group-btn" style="color: #000;">
                                                                            <a href="#" class="btn bg-success btn-sm" style="color: #FFFFFF;">查看赛题</a>
                                                                        </span>
                                                                        <span>当前有116支团队选择该赛题</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <footer class="panel-footer text-right bg-light lter">
                                                            <button type="submit" class="btn btn-success btn-s-xs">更改赛题</button>
                                                        </footer>
                                                    </section>
                                                </div>
                                            </div>
