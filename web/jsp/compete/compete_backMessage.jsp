                        ...
                        <section class="hbox stretch">
                            <aside class="bg-white">
                                <section class="vbox">
                                    ...
                                    <div class="col-sm-8">
                                        <h4>欢迎“Amazing”报名参加华中黑客邀请赛</h4>
                                        <form class="form-horizontal" data-validate="parsley">
                                            <section class="panel panel-default">
                                                <header class="panel-heading">
                                                    <strong>我的团队信息</strong>
                                                </header>
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">报名审核状态</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="通过审核" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">团队成员审核状态</label>
                                                        <div class="col-sm-9">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" value="通过审核2位" disabled="disabled">
                                                                <span class="input-group-btn">
                                                                    <a href="<%=basePath%>/jsp/compete/compete_backMessageMembers.jsp" class="btn btn-sm rounded">查看</a>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">指导老师审核状态</label>
                                                        <div class="col-sm-9">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" value="通过审核1位" disabled="disabled">
                                                                <span class="input-group-btn">
                                                                    <a href="<%=basePath%>/jsp/compete/compete_backMessageTeacher.jsp" class="btn btn-sm rounded">查看</a>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">选题审核状态</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="【A06】智能网联汽车驾驶健康伙伴系统【东软睿道】 通过审核" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">作品审核状态</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="尚未提交作品" disabled="disabled">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">竞赛</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" value="进入初赛" disabled="disabled">
                                                        </div>
                                                    </div>
                                                </div>
                                            </section>
