            ...
            <section id="content">
                <section class="hbox stretch">
                    <aside class="aside-lg bg-light b-r" id="aside">
                        <div class="wrapper">
                            <h4 class="m-t-none">添加安排</h4>
                            <form>
                                <div class="form-group">
                                    <label>标题</label>
                                    <input type="text" placeholder="输入安排标题" class="input-sm form-control">
                                </div>
                                <div class="form-group">
                                    <label>日期</label>
                                    <input type="text" placeholder="输入安排日期" class="datepicker input-sm form-control">
                                </div>
                                <div class="form-group">
                                    <label>时间</label>
                                    <input type="text" placeholder="输入安排时间 eg. 3:00 pm" class="input-sm form-control">
                                </div>
                                <div class="form-group">
                                    <label>类型</label>
                                    <div>
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn btn-sm btn-default dropdown-toggle">
                                                <span class="dropdown-label">选择类型</span>
                                                <span class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu dropdown-select">
                                                <li><input type="radio" name="d-s-r"><a href="#">旅行</a></li>
                                                <li class=""><input type="radio" name="d-s-r"><a href="#">线上</a></li>
                                                <li class=""><input type="radio" name="d-s-r"><a href="#">见面会</a></li>
                                                <li class=""><input type="radio" name="d-s-r"><a href="#">赛程</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="m-t-lg"><button class="btn btn-sm btn-default">添加安排</button></div>
                            </form>
                        </div>
                    </aside>
