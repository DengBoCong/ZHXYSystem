                                    ...
                                    <section class="scrollable">
                                        <section class="panel panel-default">
                                            <header class="panel-heading">
                                                <span class="h4">发布新商品</span>
                                            </header>
                                            <div class="panel-body">
                                                <p class="text-muted">想要发布新商品? 请填写完一下信息。</p>
                            ...
                            <aside class="aside-lg bg-light lter b-r">
                                <section class="vbox">
                                    <section class="scrollable">
                                        <section class="panel panel-default">
                                            <header class="panel-heading">
                                                <span class="h4">已发布的商品</span>
                                            </header>
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="activity">
                                                        <ul class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border">
                                                            <li class="list-group-item" style="background: gainsboro;">
                                                                <a href="#" class="thumb-sm pull-left m-r-sm">
                                                                    <img src="<%=basePath%>/img/person.jpeg" class="img-circle">
                                                                </a>
                                                                <a href="#" class="clear">
                                                                    <small class="pull-right">3 分钟前</small>
                                                                    <strong class="block">软件大作业</strong>
                                                                    <small>java期末软件大作业</small>
                                                                </a>
                                                            </li>
                                ...
                                <section class="vbox">
                                    <section class="scrollable padder-v">
                                        ...
                                        <div class="panel clearfix">
                                            <h4 class="font-thin padder">买家信息</h4>
                                            <div class="panel-body">
