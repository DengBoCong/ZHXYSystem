 ...
 **/
@Entity
@Table(name = "classification", schema = "zhxysystem", catalog = "")
@NamedQueries({
        @NamedQuery(name = "Classification.findByOwner",
        query = "SELECT classificationEntity FROM ClassificationEntity classificationEntity WHERE classificationEntity.owner = :owner")
})
